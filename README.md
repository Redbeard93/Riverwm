...
`otf-font-awesome waybar wofi rofi swaybg swayidle swaylock grim slurp wf-recorder kitty python-pillow dunst iw(for rofi_wifi_menu) networkmanager network-manager-applet wl-clipboard(for neovim clipboard) fd ripgrep`
